...
from oidc_provider.lib.utils.token import create_logout_token
from oidc_provider.lib.utils.token import encode_logout_token
...
class EndSessionEndpoint:
    ...
    def _end_session_in_rp(self, client: Client):
        ...
        if response.status_code != 200:
            logger.debug(f"Failed to logout RP {client.client_id}")
