...
from oidc_provider.lib.utils.token import create_refresh_token
from oidc_provider.lib.utils.token import create_token_with_refresh_token
from oidc_provider.models import Client
from oidc_provider.models import Code
from oidc_provider.models import Token
from oidc_provider.models import RefreshToken
    ...
    def validate_params(self):
        ...
        if self.params["grant_type"] == "authorization_code":
            ...
            if self.refresh_token.has_expired():
                logger.debug("[Token] Refresh token expired: %s", self.params["refresh_token"])
